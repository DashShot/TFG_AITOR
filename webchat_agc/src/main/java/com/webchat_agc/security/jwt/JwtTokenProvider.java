...
public class JwtTokenProvider {
	...
	private static long JWT_EXPIRATION_IN_MS = 5400000; //Duración del token JWT en milisegundos (1.5 horas).
	private static Long REFRESH_TOKEN_EXPIRATION_MSEC = 10800000l; // Duración del token de actualización en milisegundos (3 horas).
