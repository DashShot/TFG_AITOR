...
//Conect User to WebSocket antes del boton
function connect(event) {
    ...
    if (nickname && fullname) {
        ...
        stompClient.connect({}, connectUser, onError);
    }
...
function connectUser() {
    ...
    //stompClient.subscribe(`/user/${nickname}/queue/messages`, onMessageReceived);//COla de envio cambiar a room

    stompClient.subscribe(`/user/public`, onMessageReceived); //Mensajes de conexión y desconexión

    // register the connected user
    stompClient.send("/app/user.addUser", //setApplicationDestinationPrefixes
        {},
